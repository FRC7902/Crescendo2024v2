...
public class SpeakerArmAndShooter extends ParallelCommandGroup {
  /** Creates a new SpeakerArmAndShooter. */
  public SpeakerArmAndShooter(ArmSubsystem arm, ShooterSubsystem shooter) {
