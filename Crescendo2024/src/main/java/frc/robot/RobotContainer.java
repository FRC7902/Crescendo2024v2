...
public class RobotContainer {
  ...
  private final TwoNoteAmpAutoClose m_TwoNoteAmpAutoClose = new TwoNoteAmpAutoClose(m_driveSubsystem,
      m_armSubsystem,
      m_intake, m_shooterSubsystem);
  private final TwoNoteAmpAutoFar m_TwoNoteAmpAutoFar = new TwoNoteAmpAutoFar(m_driveSubsystem, m_armSubsystem,
      m_intake, m_shooterSubsystem);
  ...
  public RobotContainer() {
    ...
    m_TwoNoteAutoRightSide = new TwoNoteAutoRightSide(m_driveSubsystem, m_intake, m_shooterSubsystem,
        m_armSubsystem,
        autoDirection);
    m_TwoNoteAutoLeftSide = new TwoNoteAutoLeftSide(m_driveSubsystem, m_intake, m_shooterSubsystem,
        m_armSubsystem,
        autoDirection);
    m_ThreeNoteAutoMiddleRight = new ThreeNoteAutoMiddleRight(m_driveSubsystem, m_intake, m_armSubsystem,
  ...
  private void configureBindings() {
    ...
    new JoystickButton(m_driverStick, IOConstants.kRB)
        .whileTrue(new RotateRightOnSpotCommand(m_driveSubsystem));
    ...
    // 0, false));
    // new POVButton(m_operatorStick, 90).onTrue(new TurnToAngle(m_driveSubsystem,
    // -90, false));

    // new POVButton(m_operatorStick, 270).onTrue(new
    // DriveToDistance(m_driveSubsystem, 3));
    // new POVButton(m_operatorStick, 90).onTrue(new
    // DriveToDistance(m_driveSubsystem, -3));
