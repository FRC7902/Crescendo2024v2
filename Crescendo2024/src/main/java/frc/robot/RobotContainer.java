...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    new JoystickButton(m_operatorStick, Constants.IOConstants.kLB).whileTrue(new Suck(m_intake));//kLB
    new JoystickButton(m_operatorStick, Constants.IOConstants.kRB).whileTrue(new Spit(m_intake));//kRB
  }
